...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($usuario && password_verify($contrasena, $usuario['contrasena'])) {
        ...
        $_SESSION['capital_validator_x'] = $usuario['capital_validator_x'];
        $_SESSION['capital_trading_ia'] = $usuario['capital_trading_ia'];
        $_SESSION['admin_password'] = $contrasena; // Guardar la contraseña del administrador en la sesión
